...
if __name__ == "__main__":
    kwargs = {
        'project_name': 'motion_amplitude',
        'batch_size': 10,
        'side_length': 256,
        'pos_embed': False,
        'sequence_range': [0,300],
        'skip': 30,
    ...
    trainer = pl.Trainer(accelerator='gpu', max_epochs=1000, devices = 1, log_every_n_steps=100, enable_progress_bar=True, callbacks=[checkpoint_callback],logger=pl.loggers.CSVLogger(save_dir=kwargs['project_name'], name='log'))
